...
export default function Sections() {
  return (
    <div data-testid="sectionsTestId" className=' flex items-center w-full h-[40px]'>
        ...
        <div className=' bg-gray-300 border-b-2 border-gray-400 h-full min-w-[156px] sm:min-w-[180px] flex text-center justify-center items-center '>      
        </div>
    </div>
  )
}
