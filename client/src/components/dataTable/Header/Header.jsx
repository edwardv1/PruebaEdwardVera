...
export default function Header() {
  ...
  return (
    <div data-testid="headerTestId" className=' bg-gray-300 w-[100%] flex justify-between items-center border-t-2 border-b-2 border-gray-400 px-6 h-[60px]'>
        ...
        <button name="buttonOpenModalCreateProduct" className=' mx-1 px-3 w-[90px] sm:w-[100px] h-[40px] bg-green-500 rounded-lg text-base sm:text-lg text-white cursor-pointer' onClick={handleNewButtonClick}><b>+ New</b></button>
